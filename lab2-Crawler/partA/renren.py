...
name   = soup.find('a',{'class':'hd-name'}).get('title','')
school = soup.find('li',{'class':'school'}).string
sex    = soup.find('li',{'class':'birthday'}).contents[1].string
birth  = soup.find('li',{'class':'birthday'}).contents[3].string[1::]
place  = soup.find('li',{'class':'address'}).string
print(name)
print(school)
print(sex)
print(birth)
